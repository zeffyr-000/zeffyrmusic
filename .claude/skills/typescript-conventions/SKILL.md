...
description: TypeScript conventions for Zeffyr Music — no any, readonly on injected deps and signals, inject() over constructor injection, naming, imports, method length/complexity limits, and English-only comments. Use when editing *.ts files.
---
