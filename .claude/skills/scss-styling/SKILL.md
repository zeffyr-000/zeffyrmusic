---
name: scss-styling
description: SCSS architecture and design system for Zeffyr Music — file and import order, _custom.scss CSS custom properties, _utilities.scss sections, dark mode, hover guards, and component style budgets. Use when editing *.scss files (see css-critical-rules for the YouTube player).
---
