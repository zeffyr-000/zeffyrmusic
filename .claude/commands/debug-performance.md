---
description: Analyze and fix performance issues in the Zeffyr Music application
---
...
- ALL components run OnPush (the Angular 22 zoneless default) — `changeDetection` is omitted; `ChangeDetectionStrategy.Eager` is a red flag unless justified
