...
description: Angular template conventions for Zeffyr Music — modern control flow (@if/@for/@switch), signal call syntax, skeleton loaders, empty states, ng-bootstrap auto-ARIA, NG0956 avoidance, and required ARIA attributes. Use when creating or editing *.html templates.
---
...
via alternating class names instead — see the `angular-components` skill for the `_animTick` pattern.
