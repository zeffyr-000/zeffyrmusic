...
describe('ArtistListComponent', () => {
  ...
  it('should display artists with anchor', async () => {
    const artistsData = [
      { id_artist: '1', label: 'Artist 1' },
      { id_artist: '2', label: 'Artist 2' },
    ];

    fixture.componentRef.setInput('artists', artistsData);
    fixture.detectChanges();
  ...
  it('should display artists without anchor', async () => {
    const artistsData = [{ label: 'Artist 1' }, { label: 'Artist 2' }];
