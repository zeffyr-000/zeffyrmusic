---
description: Fix YouTube player CSS issues following the BREAKING css-critical-rules
---

# Fix CSS Player

Fix YouTube player CSS issues following the CRITICAL rules in the `css-critical-rules` skill.
