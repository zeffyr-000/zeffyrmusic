---
name: css-critical-rules
description: BREAKING CSS rules for the Zeffyr Music YouTube player — #player styles must live in global styles.scss, mobile height:1px, aspect-ratio override, and z-index above the fixed header. Read BEFORE any *.scss or *.css change, especially anything touching the player.
---
...
- Component patterns: the `angular-components` skill
