---
name: e2e-playwright
description: Playwright E2E testing for Zeffyr Music — data-testid selectors, mockApiRoutes fixtures, two-level API mocking, TransferState stripping, and the no-waitForTimeout rule. Use when creating or editing e2e/**/*.ts tests or fixtures.
---
