---
name: player-debug
description: Use this agent to debug YouTube IFrame Player issues in Zeffyr Music — player not showing, "not attached to DOM" on mobile, broken aspect ratio, playback/state-change problems, volume/seek, or mobile expand/collapse. It enforces the BREAKING player CSS rules.
...
1. Read the `css-critical-rules` and `youtube-player-lifecycle` skills — **BREAKING rules** for player CSS
