---
description: Refactor a component from legacy patterns to modern Angular signals
---
...
- OnPush is the Angular 22 zoneless default — omit `changeDetection` (only set `ChangeDetectionStrategy.Eager` if eager checking is genuinely needed)
