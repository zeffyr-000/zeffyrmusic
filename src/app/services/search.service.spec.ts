...
describe('SearchService', () => {
  ...
  describe('Server context', () => {
    ...
    it('should return empty results for fullSearch2 when in server context', () => {
      ...
      httpMock.expectNone(environment.URL_SERVER + 'fullsearch2/' + encodeURIComponent('test_query'));
    });
    ...
    it('should return empty results for fullSearch3 when in server context', () => {
      ...
      httpMock.expectNone(environment.URL_SERVER + 'fullsearch3/' + encodeURIComponent('test_query'));
    });
  });
});
