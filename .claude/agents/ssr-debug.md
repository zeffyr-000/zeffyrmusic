---
name: ssr-debug
description: Use this agent to debug Angular SSR issues in Zeffyr Music — silent CSR fallback (missing allowedHosts), hydration mismatches, "window/document is not defined" crashes, browser-API safety, and Node/PM2 deployment problems.
...
1. Read the `ssr-safety` skill for project-specific SSR rules
