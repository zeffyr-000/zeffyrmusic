...
export class QueueAnimationService {
  ...
  /**
   * Briefly pulse the last `count` rows of the desktop queue list once the
   * ghost lands. The list scroll position is left untouched. On mobile the
   * list is hidden, so the ghost flight alone provides the feedback.
   */
